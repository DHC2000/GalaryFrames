...
<head>
    ...
    <link href="{{ asset('css/dist/css/style.css') }}" rel="stylesheet">
    <script src="{{ asset('js/main.min.js') }}" ></script>
    <script src="{{ asset('css/dist/js/main.min.js') }}" ></script>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">WebComponentsMX</h1>
	                        ...
	                        <div class="hero-cta">
                            <a class="button button-primary" href="{{ route('login') }}">Ingresar</a>
